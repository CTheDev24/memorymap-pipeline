...
- USGS terrain requests are cached and retried; after repeated service timeouts, generation completes with a clearly reported flat-base fallback instead of failing the whole job.
